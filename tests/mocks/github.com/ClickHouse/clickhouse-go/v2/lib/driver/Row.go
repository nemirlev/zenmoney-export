...
func (_m *Row) ScanStruct(dest interface{}) error {
	ret := _m.Called(dest)
...
// Row_ScanStruct_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ScanStruct'
type Row_ScanStruct_Call struct {
	*mock.Call
}

// ScanStruct is a helper method to define mock.On call
//   - dest interface{}
func (_e *Row_Expecter) ScanStruct(dest interface{}) *Row_ScanStruct_Call {
	return &Row_ScanStruct_Call{Call: _e.mock.On("ScanStruct", dest)}
}

func (_c *Row_ScanStruct_Call) Run(run func(dest interface{})) *Row_ScanStruct_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Row_ScanStruct_Call) Return(_a0 error) *Row_ScanStruct_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Row_ScanStruct_Call) RunAndReturn(run func(interface{}) error) *Row_ScanStruct_Call {
	_c.Call.Return(run)
	return _c
}
