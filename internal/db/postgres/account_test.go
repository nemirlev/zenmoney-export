...
func TestCreateAccount_Success(t *testing.T) {
	...
	mock.ExpectExec(`INSERT INTO account`).
		WithArgs(
			...
			account.InBalance, optionalDecimalString(account.CreditLimit), optionalDecimalString(account.StartBalance),
			optionalDecimalString(account.Balance), account.Company, account.Archive,
			account.EnableCorrection, account.BalanceCorrectionType,
			account.StartDate, account.Capitalization, optionalDecimalString(account.Percent),
